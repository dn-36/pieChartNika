                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            ...
                            Row(modifier = Modifier
                                ...
                                Column(horizontalAlignment = Alignment.End) {
                                    Text(text = "${FinishViewModel.finishState.transaction.value.sign}${FinishViewModel.finishState.transaction.value.sum}", color = FinishViewModel.finishState.transaction.value.color, fontSize = 17.sp, fontWeight = FontWeight.Bold)
